...
# Configuration
REPO_URL="https://github.com/markshao/Orion.git"
WORKSPACE_NAME="Orion_workspace"
...
echo -e "${BLUE}🐝 Starting End-to-End Test for Orion...${NC}"

# Ensure orion is installed/updated
echo -e "${BLUE}📦 Rebuilding and installing Orion...${NC}"
cd ..
./install.sh
cd playground
...
orion spawn "$LOGICAL_BRANCH" "$NODE_NAME" --base main
...
echo "Hello from Orion E2E" > "$TEST_FILE"
